                ...
                <div className="mx-auto max-w-c-1390 px-4 md:px-8 2xl:px-0">
                    <div className="flex flex-col lg:flex-row gap-7.5 xl:gap-12.5">
                        <div className="lg:w-2/3">
                            <div
                                className="animate_top rounded-md shadow-solid-13 bg-white dark:bg-blacksection border border-stroke dark:border-strokedark p-7.5 md:p-10">
                      ...
                      {dict.oneBlog.updatedAt}:{" "}
                        {new Date(post._updatedAt).toLocaleDateString(
                            dict.dateLocale,
                            {
                                ...
                                {/*<Comment path={`${dict}/blog/${slug}`} title={post.title}/>*/}
